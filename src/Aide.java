...
public class Aide {
    ...
    static {
        ...
        "Une île marquée 3 dans un coin a 2 voisins avec un pont connecté à un voisin et 2 ponts connectés à l'autre. De manière similaire, un îlot de valeur 5 doit au minimum avoir un pont qui le connecte à ses 3 voisins
        et une île de valeur 7 doit avoir au minimum un pont qui la connecte à ses 4 voisins");
        technique.put("Cas spécial des 3 dans les coins, 5 sur les côtés et 7 au milieu",
        "Si une île est de valeur 3 et qu'un de ses voisins est une île avec l'indice 1, alors toutes les conditions sont réunies et les 3 ponts peuvent être tracés,
        la même logique peut être appliquée si une île de valeur 5 sur le côté ou une île de valeur 7 au milieu a pour voisin une île marquée par un 1");
