...
public class BaseDonneeJoueur implements Serializable {
     ...
     * @return <code>true</code> if the level was already in the database for the
     *         current player, <code>false</code> otherwise.
        ...
        for (int i = 0; i < lines.size(); i++) {
            if (Pattern.matches(lvl + ".*", lines.get(i))) {
                FileWriter fWriter = new FileWriter(
                        directory + Hashi.joueur.getnom() + "/" + Hashi.joueur.getnom() + ".prof");
     ...
     * @return <code>true</code> if the new player exists in the database,
     *         <code>false</code> otherwise
     ...
     * @return the <code>Color</code> of the chip color if the new player exists,
     ...
     * @return A <code>Joueur</code> if the player exists in the database,
     *         <code>null</code> otherwise
     * @throws Exception
     * @author Ambre Collard
     */
     ...
     * @return <code>false</code> if the player doesn't exist, <code>true</code> if
     *         it has been deleted
     * @throws Exception
     * @author Ambre Collard
     */
